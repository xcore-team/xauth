...
VERIFY_TOKEN_SCHEMA: TypedDict = {
    "token": (str, ...),
}

HAS_PERMISSION_SCHEMA: TypedDict = {
    "user_id": (str, ...),
    "tenant_id": (str, ...),
    "permission": (str, ...),
}

GET_USER_SCHEMA: TypedDict = {
    "user_id": (str, ...),
}

GET_TENANT_SCHEMA: TypedDict = {
    "tenant_id": (str, ...),
}

CREATE_INVITE_SCHEMA: TypedDict = {
    "tenant_id": (str, ...),
    "invited_by": (str, ...),
    "email": (str, ...),
    "role_id": (str, None),
...
class IPCCommands(AutoDispatchMixin):
    ...
    @validate_payload(VERIFY_TOKEN_SCHEMA, type_response="model", unset=False)
    ...
    @validate_payload(HAS_PERMISSION_SCHEMA, type_response="model", unset=False)
    ...
    @validate_payload(GET_USER_SCHEMA, type_response="model", unset=False)
    ...
    @validate_payload(GET_TENANT_SCHEMA, type_response="model", unset=False)
    ...
    @validate_payload(CREATE_INVITE_SCHEMA, type_response="model", unset=False)
    ...
    @validate_payload(LOG_EVENT_SCHEMA, type_response="model", unset=False)
